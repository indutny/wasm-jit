...
builder.opcode('state', function() {
  return { output: this.int('none') };
}, function() {
  // No-op
});

builder.opcode('updateState', function() {
  return { output: this.int('none'), inputs: [ this.int('none') ] };
}, function() {
  // No-op
});
